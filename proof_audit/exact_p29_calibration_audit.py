...
def main() -> None:
    ...
    result = {
        ...
        "local_git": {
            "branch": "audit/code-fixes",
            "exact_p29_parameter_commit": "17685d85030541c4b15f03bcabe5c36a93c10605",
            "final_simple_validator_commit": "5bb6e5cbb4c8480dd4e6b753e06861bd5fed0ae2",
        },
        "geometry": GEOMETRY,
        "calibration": {
            ...
            "captured_stdout": "proof_audit/generated/exact_p29_calibration_captured_stdout.log",
            "peak_monitor_sha256": "0fed1e2d5ea6f0c6356e25590d8d85c0aa858a0666c530c0d15185e7859492f0",
            "cloud_only_file_audit": {
                "calibration_logs_json_csv_found_remotely": [],
                "monitor_matches_committed_local_copy": True,
                "remote_source_diff_sha256": "8fe3a98ac02b5b48bed41e35b3340841709a5a821b4d763d778e5a2d03abc82e",
                "remote_source_changes_superseded_by_local_commits": True,
            },
            "tau": 32,
            "raw_NB": NB,
            "raw_PB": PB,
